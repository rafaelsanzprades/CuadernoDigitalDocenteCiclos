...
export const ResumenTab = () => {
  ...
  const students = filterEstado === "todos" ? allStudents
    ...
    : allStudents.filter((al: Alumno) => al.Estado === "Baja");
      ...
      <Card className="border border-white/5 overflow-hidden bg-foreground/3">
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/5 bg-foreground/8 text-muted text-xs uppercase tracking-wider">
                <th
                ...
                >
                  Alumno/a <SortIcon field="apellidos" />
                </th>
                        ...
                        <td colSpan={11} className="px-8 py-5">
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                            ...
                            <div className="space-y-3">
                              <div className="text-[10px] font-bold text-muted uppercase tracking-widest mb-2">🎯 Perfil</div>
                              {[
                            ...
                            {/* Col 2: Aspiraciones */}
                            <div className="space-y-3">
                              <div className="text-[10px] font-bold text-muted uppercase tracking-widest mb-2">🧭 Aspiraciones</div>
                              {[
                            ...
                            {/* Col 3: Seguimiento */}
                            <div className="space-y-3">
                              <div className="text-[10px] font-bold text-muted uppercase tracking-widest mb-2">📋 Seguimiento tutor</div>
                              {[
